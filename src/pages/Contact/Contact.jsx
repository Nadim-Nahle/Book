        ...
        <>
            ...
            <section class="contact-us" id="contact-section">
                <div className="left">
                    ...
                    <div className="info"><div className="title">linkdin: </div>   <a target="_blank" rel="noreferrer" href="http://www.linkedin.com/in/soha-yaghi-phd-98828722b">soha-yaghi-phd</a></div>
